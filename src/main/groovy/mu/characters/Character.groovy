...
import main.groovy.mu.characters.config.version.beta_first.CharacterConfig
...
abstract class Character {
     ...
     * @see main.groovy.mu.characters.config.CharacterData.CHARACTER_ID_XX
     * @return
     */
    ...
    static def newFromVersion(charId, level, version){
        def charConfig = Class.forName("main.groovy.mu.characters.config.version.${version}.CharacterConfig").newInstance()
        def charClass = Class.forName("main.groovy.mu.characters.${charId}")
